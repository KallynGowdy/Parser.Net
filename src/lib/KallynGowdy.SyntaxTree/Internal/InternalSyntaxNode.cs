...
namespace KallynGowdy.SyntaxTree.Internal
{
	...
	public abstract class InternalSyntaxNode : IEquatable<InternalSyntaxNode>
	{
	    ...
	    /// </summary>
        public virtual bool IsMissing { get; } = false;

		/// <summary>
		/// Gets the length of this node. Also known as the width.
		/// </summary>
		public virtual int Length => Children.Where(c => c != null).Sum(c => c.Length);
		...
		/// <param name="tree">The tree of the node.</param>
		/// <returns></returns>
