...
{
	/// <summary>
	///     Provides an abstract class that defines an action that the parser should take when input is read based on the
	///     current state.
	/// </summary>
		...
		where T : IEquatable<T>
	{
		...
		/// </summary>
		[DataMember]
		public ParseTable<T> ParseTable { get; private set; }
	}
}