...
namespace KallynGowdy.ParserGenerator.Collections
{
    ...
    /// </summary>
    public class MultiHashedDictionary<TKey, TValue> : IDictionary<TKey, TValue> where TKey : IMultiHashedObject
    {
        private Dictionary<int, TValue> lookup;
        ...
        public TValue this[TKey key]
        {
            get
            {
                return lookup[keys.GetHashCode()];
            }
            set
            {
                lookup[keys.GetHashCode()] = value;
            }
        }
